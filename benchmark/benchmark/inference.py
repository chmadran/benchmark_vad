...
def run_inference(dataset:list, experiments:dict, log_dir:Path) -> tuple[list, dict]:
    """
    Run benchmarking for multiple models across best model parameter combinations and audio files, 
    and log the results.
    ...
    if not dataset:
        print("Empty dataset to run inference on.")
